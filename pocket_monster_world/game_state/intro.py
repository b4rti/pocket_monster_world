...
class IntroState(GameState):
    ...
    def __init__(self, game):
        super().__init__(game)
        self.logo = pygame.image.load("assets/img/logo.png").convert_alpha()
        self.logo = pygame.transform.scale(self.logo, (700, 200))
        self.psyduck = pygame.image.load("assets/img/pokemon/psyduck/front_default.png").convert_alpha()
        self.psyduck = pygame.transform.scale(self.psyduck, (400, 400))
        self.text = self.game.font.render("Press any key to continue...", False, (0, 0, 0))
