...
class IntroState(GameState):
    ...
    def __init__(self, game: 'Game'):
        super().__init__(game)
        self.logo = pygame.image.load("assets/img/pokemon_logo.png")
        self.psyduck = pygame.image.load("assets/img/pokemon/psyduck/front_default.png")
        self.psyduck = pygame.transform.scale(self.psyduck, (200, 200))
    ...
    def render(self):
        self.game.screen.blit(self.logo, (300, 150))
        self.game.screen.blit(self.psyduck, (300, 200))
